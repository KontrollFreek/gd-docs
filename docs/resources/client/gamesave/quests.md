...
| --- | ---------- | --------------------------------------------------- | ---------------------------------------------------------------------------------------------------- |
| `1` | Type       | [Quest Type](/resources/client/enumerations.md)     | This is used to diffrenciate the type of quest needs to be completed: 1 = Orbs, 2 = Coins, 3 = Stars |
...
| `8` | Position   | [Quest Position](/resources/client/enumerations.md) | where abouts on screen the quest should be: 1 = top, 2 = middle, 3 = bottom                          |